...
def iniciar():
    while True:
        ...
        if opcion == "1":
            ...
            cliente=dni.Clientes.buscar(dni)
            ...
            apellido = helpers.leer_texto(2, 30, "Apellidp (de 2 a 30 chars)"). capitalize()
            ...
            if cliente:
             ...
             apellido = helpers.leer_texto(
                 2, 30, f"Apellidp (de 2 a 30 chars)[{cliente.apellido}]"). capitalize()
